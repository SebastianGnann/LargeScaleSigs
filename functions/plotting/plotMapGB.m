function [] = plotMapGB(lat,lon,z,varargin)
%plotMapGB Plots GB map with dots coloured according to an attribute.
%   Options:
...
%   figure_name: name for saving, e.g. 'GB_map'
...
addParameter(ip, 'figure_name', 'map_GB', @ischar)
...
shapefile = shaperead('great_britain_50m.shp', 'UseGeoCoords', true);
...
%% save fig
if save_figure
    saveFig(fig,strcat('GB_',figure_name),figure_path,figure_type)
end
