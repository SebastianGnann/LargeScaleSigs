function [] = plotMapBR(lat,lon,z,varargin)
%plotMapBR Plots BR map with dots coloured according to an attribute.
%   Options:
...
%   figure_name: name for saving, e.g. 'BR_map'
...
addParameter(ip, 'figure_name', 'map_BR', @ischar)
...
c = colorbar;
c.Position = [0.3 0.2 0.014 0.1875]; 
